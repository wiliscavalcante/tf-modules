...
variable "required_tags" {
  description = "A map of required tags to apply to all resources. These tags help with resource management, cost allocation, and automation."
  type        = map(string)
  default = {
